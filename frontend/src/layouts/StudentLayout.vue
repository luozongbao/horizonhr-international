...
const navItems = computed<NavItem[]>(() => [
  { icon: 'House',        label: t('student.dashboard'),    route: '/student/dashboard' },
  { icon: 'User',         label: t('student.profile'),      route: '/student/profile' },
  { icon: 'Document',     label: t('student.resume'),       route: '/student/resume' },
  { icon: 'Briefcase',    label: t('student.applications'), route: '/student/applications' },
  { icon: 'VideoCamera',  label: t('student.interviews'),   route: '/student/interviews' },
  { icon: 'Collection',   label: t('student.seminars'),     route: '/student/seminars' },
])

// Page title from route meta or current nav item
    ...
    <aside class="sidebar" :class="{ collapsed }">
      ...
      <div class="sidebar-logo">
        <router-link to="/" class="logo-text">
          ...
          <span v-if="!collapsed" class="logo-sub">Student Portal</span>
        </router-link>
      </div>
